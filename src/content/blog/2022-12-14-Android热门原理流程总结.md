...
[【Android进阶】JVM&DVM&ART虚拟机对比](./2022-12-5-JVM&DVM&ART虚拟机对比.md)
...
## 线程池
见另一篇文章：
[【通用开发】Java线程池](./2023-7-15-Java线程池.md)

## 安卓设备开机流程
作为应用开发，除了SystemUI和Launcher外，我们更多关注的是应用层的启动流程。对于系统启动稍作了解即可。

[【Android进阶】Android设备开机流程](./2022-12-12-Android设备开机流程.md)

## 冷启动流程
见另一篇文章：
[【Android进阶】APP冷启动流程解析](./2022-12-7-2022-12-7-APP冷启动流程解析.md)

## Handler & 消息处理机制

[【Android进阶】Handler消息机制的上下层设计与流程详解](./2022-12-30-Handler消息机制的上下层设计与流程详解.md)
