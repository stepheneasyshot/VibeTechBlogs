---
title: "端侧模型部署llama.cpp篇"
description: >
  Android端侧llama.cpp模型部署
pubDate: 2025-08-06
category: ["AI", "Android"]
featured: false
draft: false
...
[【AI】大模型开发流程和运行环境简介](./2025-8-5-LLM开发流程和运行环境简介.md)
...
![](/images/blog/blogs_ai_llamacpp.webp)
...
[【AI】LLM中张量的计算](./2025-8-2-LLM中张量的计算.md)
...
![](/images/blog/blogs_gguf_file_structure.webp)

## 运行原理简介
详细运行流程见原文：

[【AI】Understanding how LLM inference works with llama.cpp](./Understanding%20how%20LLM%20inference%20works%20with%20llama.cpp.md)
...
![](/images/blog/blogs_ai_termux_clone_llamacpp.webp)
...
![](/images/blog/blogs_ai_termux_build_llamacpp.webp)
...
![](/images/blog/blogs_ai_termux_get_file_permissions.webp)

出现管理所有文件的权限授予弹窗，打开之后将文件复制到内部目录：

![](/images/blog/blogs_ai_termux_copy_model_gguf_file.webp)
...
![](/images/blog/blogs_ai_termux_run_deepseek_model.webp)
...
![](/images/blog/blogs_ai_termux_run_deepseek_model_as_server.webp)
...
<img src="/images/blog/blogs_local_llm_server_client.webp" width="300" height="620" loading="lazy" />
...
<img src="/images/blog/blogs_ai_llamacpp_smollchat.webp" width="250" height="580" loading="lazy" />
...
<img src="/images/blog/blogs_local_llm_load_models.webp" width="600" height="360" loading="lazy" />

打开实时的片段生成和性能追踪对比。推理过程的打印日志如下：

![](/images/blog/blogs_ai_llamacpp_running_log.webp)

使用 `Android Studio` 的 `Profiler` ，实时性能监控：

![](/images/blog/blogs_ai_llamacpp_running_live_telemetry.webp)
