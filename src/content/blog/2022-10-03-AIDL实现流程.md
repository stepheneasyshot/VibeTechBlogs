...
featured: false
draft: false
image: "/images/blog/blogs_aidl.webp"
---
# 应用层AIDL接口的实现
通常包括以下步骤
## 定义AIDL接口文件
...
<img src="/images/blog/blogs_aidl_server.webp" alt="server" width="400" height="300" loading="lazy" />
...
<img src="/images/blog/blogs_aidl_client.webp" alt="client" width="400" height="300" loading="lazy" />
