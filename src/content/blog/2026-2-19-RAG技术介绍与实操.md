...
featured: false
draft: false
image: "/images/blog/blogs_cover_rag.webp"
---
# RAG技术介绍与实操
...
📚 【检索结果】
  [1] 相关度: 0.6225 | 来源: 2022-12-12-Android设备开机流程.md
      内容: 通常是芯片内部固化的一段非常小的启动代码(BootROM)。这段代码是芯片制造商预先写入的，不可修改

## 执行芯片内...
  [2] 相关度: 0.6050 | 来源: 2022-12-14-Android热门原理流程总结.md
      内容: ## 内存泄漏常见场景
见性能优化篇：
[【Android性能优化】内存](./
    ...
    [来自文件: 2022-12-12-Android设备开机流程.md]
...
引用了具体的Markdown文档作为知识来源（如2022-12-12-Android设备开机流程.md）
