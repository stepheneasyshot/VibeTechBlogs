...
featured: false
draft: false
image: "/images/blog/blogs_network_page.webp"
---
# 编码与加密
## 加密
### 对称加密
...
<img src="/images/blog/blogs_asymmetric_encryption.webp" alt="blogs_asymmetric_encryption.png" width="400" height="120" loading="lazy" />
...
<img src="/images/blog/blogs_asymmetric_encryption_2.webp" alt="blogs_asymmetric_encryption_2.png" width="500" height="200" loading="lazy" />
...
<img src="/images/blog/blogs_sign.webp" alt="blogs_sign.png" width="300" height="160" loading="lazy" />
...
<img src="/images/blog/blogs_sign_and_encryption.webp" alt="blogs_sign_and_encryption" width="400" height="200" loading="lazy" />

### 防伪造
坏人C用B的公钥来制造加密假数据，B拿到后，用自己的私钥一解密也可以得到正常的数据。

<img src="/images/blog/blogs_fake_data.webp" alt="blogs_fake_data.png" width="400" height="200" loading="lazy" />
...
<img src="/images/blog/blogs_base64_char_table.webp" alt="image-20230707171520902" width="300" height="400" loading="lazy" />

例如将字符串"Man"进行Base64编码：

<img src="/images/blog/blogs_base64_man.webp" alt="image-20230707171609806" width="360" height="180" loading="lazy" />

转换后的位数不是6的整数时，会对末尾进行补0:

<img src="/images/blog/blogs_base64_zero_fill.webp" alt="image-20230707171722022" width="400" height="200" loading="lazy" />
...
<img src="/images/blog/blogs_compress_picture.webp" alt="blogs_compress_picture.png" width="600" height="400" loading="lazy" />
...
<img src="/images/blog/blogs_hash.webp" alt="blogs_hash.webp" width="600" height="250" loading="lazy" />
