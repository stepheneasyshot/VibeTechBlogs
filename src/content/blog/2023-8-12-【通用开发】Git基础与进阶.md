...
featured: false
draft: false
image: "/images/blog/blogs_git_logo.png"
---
# 【通用开发】Git基础与进阶
Git的各个库的组成部分主要分为以下几个区域：

<img src="/images/blog/blogs_git_flow.png" alt="git_status" width="600" height = "300" loading="lazy" />
...
<img src="/images/blog/blogs_git_revert.png" alt="git_revert_demo" width="600" height = "300" loading="lazy" />
##### 解决方案
...
![rebase](/images/blog/blogs_rebase.png)
